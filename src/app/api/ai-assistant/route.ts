...
const CATEGORY_MAP: Record<string, string[]> = {
  ...
  "Dla dziadka": ["charakterne", "pasje"],
  "Dla babci":   ["personalizacja-i-okazje", "charakterne"],
  "Dla dziecka": ["zodiak-i-astrologia", "merch"],
  "Dla szefa":   ["kierownik-tego-cyrku"],
  "Dla kumpla":  ["kierownik-tego-cyrku", "charakterne", "pasje"],
